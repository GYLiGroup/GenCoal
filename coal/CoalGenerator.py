...
class CoalGenerator:
    ...
    def run(self):
        current_smiles_list = []
        for C_moles in self.C_moles_list:
            ...
            self.target_atomNum, adjusted_target_atomNum = ut.getTarget(self.C90, self.C180, self.ele_ratio, C_moles, type=self.type)
            ...
            for selection_dic in cn_list:
                ...
                final_nested_dict_count_list = ut.backtrack_combinations(nested_dict_H, selection_dic, adjusted_target_atomNum['O_S'])
            ...
            current_smiles_list.append(current_smiles)
